...
public class GetTasksHandler : IRequestHandler<GetTaskRequest, GetTaskResponse>
{
    ...
    public async Task<GetTaskResponse> Handle(GetTaskRequest request, CancellationToken cancellationToken)
    {
        ...
        if (!string.IsNullOrEmpty(dataFromCache))
        {
            ...
            var taskEntity = JsonSerializer.Deserialize<TaskEntityGetDTO>(dataFromCache);
            var getTaskResponse = new GetTaskResponse
            {
                TaskEntityGetDto = new TaskEntityGetDTO()
                {
                    Id = taskEntity.Id,
        ...
        var taskDto = new TaskEntityGetDTO
        {
        ...
        return new GetTaskResponse { TaskEntityGetDto = taskDto }; ;
    }
}